        ...
        <div class="row-fluid">
            <div class="span7">
                <ul class="nav nav-pills">
                    <li>
                        <a href="/monkey-forms/${form.id}">
                            <i class="icon-list-alt"></i> Анкета
                        </a>
                    </li>
                    <li class="<%= requestURI.contains("forms/${form.idForm}/answers")? "active": "" %>">
                        <a href="/monkey-forms/${form.id}/answers">
                            <i class="icon-check"></i> Ответы
                        </a>
                    </li>
                    <li><a href="/forms/${form.id}/analysis/basic"><i class="icon-tasks"></i> Анализ</a></li>
                </ul>
            </div>
            <div class="span5">
                <div class="btn-group pull-right">
                    <a class="btn btn-info" id="btn-link" data-href="${form.preview_url}"><i class="icon-globe"></i> Получить ссылку</a>
